...
public class WildcardExample<T extends Number> {
    ...
    public void getList(List<? extends Number> list) {  //Here we can pass "Number type" as well its subclasses.
        // do something
    }

//    public void getList(List<Number> list) {   //Here we can only pass "Number type" not its subclasses.
//        // do something
//    }
